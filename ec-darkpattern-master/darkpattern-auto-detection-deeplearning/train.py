...
def cross_validation(
    ...
    Load & Define dataset.
    """
    df = pd.read_csv("/content/drive/MyDrive/testing_data/Dark_pattern_dataset/ec-darkpattern-master/dataset/dataset.tsv", sep="\t", encoding="utf-8")
    ...
    for fold, (train_idx, test_idx) in enumerate(skf.split(texts, labels)):
        ...
        Save model.
        """
        NN_MODEL_PICKLES_PATH = "/content/drive/MyDrive/testing_data/Dark_pattern_dataset/ec-darkpattern-master/darkpattern-auto-detection-deeplearning/model_weights/"
